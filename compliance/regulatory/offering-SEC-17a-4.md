...
It is the assessor's opinion that Azure Storage with the *immutable storage for Azure Blobs* feature and *locked time-based policy* option retains time-based Blobs (records) in a non-erasable and non-rewritable format and meets relevant storage requirements of SEC Rule 17a-4(f), [FINRA Rule 4511(c)](/azure/compliance/offering-finra-4511-us.md), and the principles-based requirements of [CFTC Rule 1.31(c)-(d)](offering-cftc-1-31-us.md).
