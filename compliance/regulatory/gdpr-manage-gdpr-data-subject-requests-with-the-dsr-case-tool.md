---
title: Manage GDPR data subject requests with DSR case tool in the Microsoft Purview portal
...
# Manage GDPR data subject requests with the DSR case tool in the Microsoft Purview portal
...
To manage investigations in response to a DSR submitted by a person in your organization, you can use the DSR case tool in the compliance center to find content stored in:
...
- Control who has access to the DSR case by adding people as members of the case; only members can access the case and can only see their cases in the list of cases on the **DSR cases** page in the compliance center. Also, you can assign different permissions to different members of the same case. For example, you can allow some members to only view the case and search results and allow other members to create searches and export search results.
...
2. In the left pane of the Microsoft Purview portal, select **Data subject requests**.

3. On the **Data subject requests** page, click **Create a case**.

4. On the **New DSR case** wizard page, give the case a name, type an optional description, and then click **Next**. The name of the case must be unique in your organization.
...
5. On the **Request details** page, under **Data subject (the person who filed this request)**, select the person that you want to find and export data for and then click **Next**.
...
7. Click **Finish** so that you can go in to the new DSR case and add members to it.

8. On the **Data subject requests** page, click the name of the DSR case that you created.
...
10. Select the people to add as members of the DSR case, click **Add**, and then save your changes.
...
1. In the Microsoft Purview portal, click **Data subject requests**, select the case that you created in Step 2, and then click **Open case**.
...
1. In the Microsoft Purview portal, click **Data subject requests**, and then click **Open case** next to the DSR case for the data subject that you want to export usage data for. 
...
1. Open the DSR case and create a search on the **Searches** page.
